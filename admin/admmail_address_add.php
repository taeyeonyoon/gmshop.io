									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td height="30">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td><img src="image/webmail/icon0.gif" width="8" height="9"><font color="#FF6600"> <b>개인 추가하기</b></font></td>
														<td>&nbsp;</td>
														...
														<td bgcolor="f4f4f4">
															...
															<table width="100%" border="0" cellspacing="2" cellpadding="3" align="center">
																...
																<tr>
																	...
																	<td> <input type="text" name="birth1" size="5" class="box" <?=__ONLY_NUM?> maxlength="4">년 <input type="text" name="birth2" size="3" class="box" <?=__ONLY_NUM?> maxlength="2">월 <input type="text" name="birth3" size="3" class="box" <?=__ONLY_NUM?> maxlength="2">일</td>
																</tr>
																<tr>
