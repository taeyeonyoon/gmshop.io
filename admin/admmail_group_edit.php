									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											<td height="30">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td><img src="image/webmail/icon0.gif" width="8" height="9"><font color="#FF6600"> <b>그룹 수정하기</b></font></td>
														<td>&nbsp;</td>
														<td width="63"><a href="javascript:groupSendit();"><img src="image/webmail/save_btn.gif" width="58" height="23" border="0"></a></td>
														<td width="65"><a href="admmail_group.php"><img src="image/webmail/cancel_btn.gif" width="58" height="23" border="0"></a></td>
													</tr>
												</table>
											</td>
										</tr><?
										$group_info = $MySQL->fetch_array("select * from webmail_adr_grp where idx=$idx");
										?>
										<tr>
											<td height="30">
												<table width="100%" border="0" cellspacing="1" cellpadding="10" bgcolor="cdcdcd">
													<tr>
														<td bgcolor="f4f4f4">
															<form name="wForm" method="post" action="admmail_group_edit_ok.php">
															...
															<table width="100%" border="0" cellspacing="2" cellpadding="5" align="center">
																<tr>
																	...
																	<td> <input type="text" name="name" size="50" class="box" value="<?=$group_info[name]?>"></td>
																</tr>
																<tr>
																	<td height="35" width="80" bgcolor="e6e6e6"> <div align="center">설명</div></td>
																	<td> <textarea name="content" rows="5" cols="60" class="text"><?=$group_info[content]?></textarea></td>
																</tr>
															</table></form>
														</td>
													</tr>
