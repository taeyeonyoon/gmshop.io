							...
							<tr>
								<td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" height="420" bgcolor="#FFFFFF">
										...
										<tr>
											<td width="80" height="30" bgcolor="#FAFAFA">&nbsp;&nbsp;<img src="image/icon.gif" width="11" height="11"> 비밀번호</td>
											<td width="427" height="30">&nbsp;&nbsp;<input class="box" type="password" name="pwd" size="20"  value="<?=$view_row[pwd]?>"> <br><input type="checkbox" name="bLock" value="y" <?if ($bbs_row[bLock]=="y") echo "checked";?>> 게시물 잠금 (본인과 관리자만 열람가능)</td>
										</tr>
										<tr>
											<td colspan="2" height="1" background="image/line_bg1.gif"></td>
										</tr><?
