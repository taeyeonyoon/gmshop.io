...
{
	<? if (__DEMOPAGE){ ?>
	alert("데모페이지는 히트상품전 수정기능이 제한되어 있습니다.");
	<? }else{ ?>
	var form=document.hitForm;
...
function ColsChange()
{
	...
	if (form.mainHitColsChange.checked == true)
	{
		...
		var cols = form.mainHitGoodsIH.value; ////세로출력수
	}
				...
				<tr>
					<td valign="top">
						<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
							...
							<tr>
								<td colspan="2" valign="top" height="25"><img src="image/design_main_icon.gif" width="21" height="11">F 화면 구성</td>
							</tr>
							<tr>
								<td colspan="2">
										...
										<tr>
											<td bgcolor="#FFF3E1" align="center" height="40">
												<table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
													<tr>
														<td height="40"> * 히트 상품전 타이틀 이미지 등록 </td>
													</tr>
												</table>
											</td>
										</tr>
							...
							<tr>
								<td colspan="2" valign="top" height="25"><img src="image/design_main_icon.gif" width="21" height="11">히트 상품전 또는 이벤트. 광고</td>
							</tr>
								...
								<td colspan="2" height="50">
									<table width="100%" border="1" cellspacing="0" cellpadding="2" align="center" bordercolor="#FFD28E" bordercolordark="#ffffff">
										<tr>
											...
											<td> <div align="center"> <input type="radio" name="mainHitApp" value="1" onclick="javascript:showApp();" <?if($design[mainHitApp]==1)echo"checked";?>>가로 X 세로 고정출력</div></td>
											<td> <div align="center"> <input type="radio" name="mainHitApp" value="0" onclick="javascript:showApp();" <?if(!$design[mainHitApp])echo"checked";?>>HTML 사용</div></td>
											<td> <div align="center"> <input type="radio" name="mainHitApp" value="2" onclick="javascript:showApp();" <?if($design[mainHitApp]==2)echo"checked";?>>자동 스크롤뷰</div></td>
										...
										<tr>
											<td colspan=5><font class="help">※ 자동스크롤뷰는 가로출력수 4<b>(고정)</b><br>※ 자동스크롤뷰는 베스트상품전,히트상품전 중 <b>한곳에만 적용</b> 가능합니다.<br>※ <b>상품정보이미지 사용</b>은 상품등록시에 <b>상품정보이미지</b>를 등록했을때 메인에서만 사용가능합니다. </td>
										</tr>
									</table>
								</td>
							</tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" >
										<tr>
											<td>
												<table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" bordercolor="#FFD28E" bordercolordark="#ffffff">
													<tr>
														<td bgcolor="#FFF3E1" width=200> <div align="center"><b>히트 상품전 타이틀 이미지</b></div></td>
													</tr>
													<tr>
										...
										<tr>
											<td><br>
												<table width="100%" border="1" cellspacing="0" cellpadding="2" align="center" bordercolor="#FFD28E" bordercolordark="#ffffff">
													<tr>
														<td width="200" bgcolor="#FFF3E1"> <div align="center">히트 상품전 목록 수</div></td>
														<td width="400">
															<table width="100%" border="0" cellspacing="0" cellpadding="0">
																<tr>
																...
																<tr>
																	<td align="center"> <input class="box" type="text" name="mainHitGoodsW" value="<?=$design[mainHitGoodsW]?>" size="10" <?=__ONLY_NUM?>> × <input class="box" type="text" name="mainHitGoodsH" value="<?=$design[mainHitGoodsH]?>" size="10" <?=__ONLY_NUM?>><br>각 행 마다 열 갯수 변경 기능 <input type="checkbox" value="y" name="mainHitColsChange" onclick="ColsChange();" <? if ($design[mainHitColsChange]=="y") echo "checked";?>>사용함 <br><font class="help">※ 세로출력수 변경시 <b>일단 저장후</b> 열 변경 <br>※ 본기능 사용시 아래의 <b>이미지 사이즈 적용안됨</b> </font>
