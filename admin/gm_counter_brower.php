...
function _gm_counter($gm_year,$gm_month,$gm_day)
{
	...
	$result=$MySQL->query("SELECT count(distinct(gm_session_id)) as a, gm_brower as b FROM GM_Counter $where_qry GROUP BY gm_brower ORDER BY a DESC, binary(gm_brower) ASC");
	$loop = 0;
				...
				<tr>
					<td>
						<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
							...
							<tr>
								<td width='440'><img src="image/log_tit_brower.gif"></td>
							</tr>
							<tr>
								<td width='1' bgcolor='dadada' colspan='3'></td>
							</tr>
								...
								<td bgcolor="#FFFFCC" style='padding:8 8 8 8' valign='top'>
									...
									for($i=0;$i<count($_day1);$i++)
									{
										...
										<tr bgcolor="#FFFFCC">
											...
											<td width='150' style='padding:2 0 2 2'><?= $_day1[$i][b]?$_day1[$i][b]:"Unknow"?></td>
										</tr><?
										}
									}
									?>
								...
								<td bgcolor="#EEEEEE" style='padding:8 8 8 8' valign='top'>
									...
									for($i=0;$i<count($_day2);$i++)
									{
										...
										<tr bgcolor="#EEEEEE">
											...
											<td width='150' style='padding:2 0 2 2'><?= $_day2[$i][b]?$_day2[$i][b]:"Unknow"?></td>
										</tr><?
										}
									}
									?>
								...
								<td bgcolor="#EEEEEE" style='padding:8 8 8 8' valign='top'>
									...
									for($i=0;$i<count($_day3);$i++)
									{
										...
										<tr bgcolor="#EEEEEE">
											...
											<td width='150' style='padding:2 0 2 2'><?= $_day3[$i][b]?$_day3[$i][b]:"Unknow"?></td>
										</tr><?
										}
									}
									?>
								...
								<td bgcolor="#FFFFCC" style='padding:8 8 8 8' valign='top'>
									...
									for($i=0;$i<count($_mon1);$i++)
									{
										...
										<tr bgcolor="#FFFFCC">
											...
											<td width='150' style='padding:2 0 2 2'><?= $_mon1[$i][b]?$_mon1[$i][b]:"Unknow"?></td>
										</tr><?
										}
									}
									?>
								...
								<td bgcolor="#EEEEEE" style='padding:8 8 8 8' valign='top'>
									...
									for($i=0;$i<count($_mon2);$i++)
									{
										...
										<tr bgcolor="#EEEEEE">
											...
											<td width='150' style='padding:2 0 2 2'><?= $_mon2[$i][b]?$_mon2[$i][b]:"Unknow"?></td>
										</tr><?
										}
									}
									?>
								...
								<td bgcolor="#EEEEEE" style='padding:8 8 8 8' valign='top'>
									...
									for($i=0;$i<count($_mon3);$i++)
									{
										...
										<tr bgcolor="#EEEEEE">
											...
											<td width='150' style='padding:2 0 2 2'><?= $_mon3[$i][b]?$_mon3[$i][b]:"Unknow"?></td>
										</tr><?
										}
									}
									?>
								...
								<td bgcolor="#DBDBDB" style='padding:8 8 8 8' valign='top'>
									...
									for($i=0;$i<count($_total);$i++)
									{
										...
										<tr bgcolor="#DBDBDB">
											...
											<td width='150' style='padding:2 0 2 2'><?= $_total[$i][b]?$_total[$i][b]:"Unknow"?></td>
										</tr><?
										}
									}
									?>
