...
function _gm_counter($gm_year,$gm_month,$gm_day)
{
	...
	$result=$MySQL->query("SELECT count(distinct(gm_session_id)) as a, gm_os as b FROM GM_Counter $where_qry GROUP BY gm_os ORDER BY a DESC, binary(gm_os) ASC");
	$loop = 0;
				...
				<tr>
					<td>
						<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
							...
							<tr>
								<td width='440'><img src="image/log_tit_os.gif"></td>
							</tr>
							<tr>
								<td width='1' bgcolor='dadada' colspan='3'></td>
							</tr>
