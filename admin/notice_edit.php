...
//팝업창 기본틀 사용여부 disabled 토글함수 
function Nosizefix()
{
	var form=document.writeForm;
	if(form.bBasicimg[0].checked)
	{
		showObject(form.width,false);		//시작일
		showObject(form.height,false);		//종료일
	}
	else
	{
								...
								<td valign="top">
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" height="420">
										...
										<tr valign="middle">
											...
											<td width="447" height="30"> &nbsp;&nbsp; <select name="gubun" class="box"><option value="">▶전체</option><option value="M" <? if ($view_row[gubun]=="M") echo "selected";?>>회원,비회원</option><option value="D" <? if ($view_row[gubun]=="D") echo "selected";?>>도매회원</option></select></td>
										</tr>
										<tr>
											<td colspan="2" height="1" background="image/line_bg1.gif"></td>
										</tr>
										<tr valign="middle">
											<td width="153" height="30" bgcolor="#FAFAFA"> <div align="left">&nbsp;&nbsp;<img src="image/icon.gif" width="11" height="11"> 제 목</div></td>
										...
										<tr valign="middle">
											<td width="153" height="30" bgcolor="#FAFAFA"> <div align="left">&nbsp;&nbsp;<img src="image/icon.gif" width="11" height="11"> 메인 팝업창 사용</div></td>
											<td width="447" height="25">
												<table width="251" border="0" cellspacing="0" cellpadding="0" align="left">
													...
													<tr>
														<td colspan=4><font class="help">&nbsp;※ 메인접속시 자동으로 창 띄움</font></td>
													</tr>
												</table>
											</td>
										</tr>
										...
										<tr>
											<td width="153" height="30" bgcolor="#FAFAFA">&nbsp;&nbsp;<img src="image/icon.gif" width="11" height="11"> 팝업 시작일</td>
											<td width="447" height="25"> &nbsp;&nbsp; <input class="box"name="sday" type="text" id="sday" size="8" maxlength="8" <?=__ONLY_NUM?> style="background-color:#dddddd;" disabled value="<?=$view_row[sday]?>"><font color="#0099CC">(예 20030101)</font></td>
										</tr>
										<tr>
											<td colspan="2" height="1" background="image/line_bg1.gif"></td>
										</tr>
										<tr>
											<td width="153" height="30" bgcolor="#FAFAFA">&nbsp;&nbsp;<img src="image/icon.gif" width="11" height="11"> 팝업 종료일</td>
											<td width="447" height="25"> &nbsp;&nbsp; <input class="box"name="eday" type="text" id="eday" size="8" maxlength="8" <?=__ONLY_NUM?> style="background-color:#dddddd;" disabled value="<?=$view_row[eday]?>"><font color="#0099CC">(예 20030131) </font></td>
										</tr>
										<tr>
											<td colspan="2" height="1" background="image/line_bg1.gif"></td>
										</tr>
										...
										<tr>
											<td width="153" rowspan="3" bgcolor="#FAFAFA">&nbsp;&nbsp;<img src="image/icon.gif" width="11" height="11"> 팝업창 크기</td>
											<td width="447" height="25"> &nbsp;&nbsp;<font color="#0099CC"> 가로크기</font> &nbsp; <input class="box"name="width" type="text" id="width" size="10" <?=__ONLY_NUM?>  value="<?=$view_row[width]?>"> px</td>
										</tr>
										<tr>
											<td height="1" background="image/line_bg1.gif"></td>
										</tr>
										<tr>
											<td width="447" height="25"> &nbsp;&nbsp; <font color="#0099CC">세로크기</font> &nbsp; <input class="box"name="height" type="text" id="height" size="10" <?=__ONLY_NUM?>  value="<?=$view_row[height]?>"> px</td>
										</tr>
										<tr>
											<td colspan="2" height="1" background="image/line_bg1.gif"></td>
										</tr><?
										...
										<tr>
											<td width="153" height="20" bgcolor="#FAFAFA">&nbsp;&nbsp;<img src="image/icon.gif" width="11" height="11"> 내용</td>
