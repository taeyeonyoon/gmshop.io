...
$PrevMonth = date("Ym",mktime(0,0,0,$smonth-1,1,$syear));
$NextMonth = date("Ym",mktime(0,0,0,$smonth+1,1,$syear));
		...
		<td width="85%" valign="top">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" align='center'>
				...
				<tr>
					<td>
						<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
							...
							<tr>
								<td width='440'><img src='image/sale_tit1.gif'></td>
							</tr>
							<tr>
								<td width='1' bgcolor='dadada' colspan='3'></td>
							</tr>
				...
				<tr>
					...
					?></select> <input type='image' src='image/view_btn.gif' border='0' align='absmiddle'>&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?= $_SERVER[PHP_SELF]?>?syear=<?=substr($PrevMonth,0,4)?>&smonth=<?=substr($PrevMonth,4,2)?>"><img src='image/pre_mon.gif' border='0' align='absmiddle'></a>&nbsp;&nbsp;<a href="<?= $_SERVER[PHP_SELF]?>?syear=<?=substr($NextMonth,0,4)?>&smonth=<?=substr($NextMonth,4,2)?>"><img src='image/next_mon.gif' border='0' align='absmiddle'></a></td>
				</tr>
				</form>
				<tr>
					<td align='center'><br>
