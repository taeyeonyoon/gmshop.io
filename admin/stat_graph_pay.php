							...
							<tr>
								<td valign="top">
									<table width="750" border="0" cellspacing="1" bgcolor='cdcdcd' cellpadding="0">
										<tr valign="middle">
											<td width="80" bgcolor="#EBEBEB" height="30"> <div align="center"><img src="image/icon.gif" width="11" height="11"> 연도</div></td>
										...
										{
											if($total_buyNum[0])			  $cntP			= $row[1]/$total_buyNum[0]*100*2.3;					//구매수 퍼센트
											else				  	  $cntP			= 0;			//구매수 퍼센트
										...
										<tr>
											...
											if ($sumPrice[0])
											{
												?>
										<tr bgcolor="ffffff">
											<td valign="middle" align="center"><?=$row[0]?>년도<br>우수구매자</td>
											<td colspan="3">
