...
$view_row = $MySQL->fetch_array("select *from bbs_data where idx=$dataArr[idx] limit 1"); //게시판 정보
//파일첨부
if(!empty($up_file_name))
{
	if(!empty($view_row[up_file])) @unlink("./upload/bbs/$view_row[up_file]"); //기존파일삭제
