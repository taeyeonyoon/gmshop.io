...
<TABLE cellSpacing='0' cellPadding='0' width='700' align='center' border='0'>
	<TR>
		<TD background='http://$admin_row[shopUrl]/admin/image/good_mail_join_tit.gif' style='padding:5 5 5 35' height='85'>$logo</TD>
	</TR>
</table>
<TABLE cellSpacing='0' cellPadding='0' width='700' align='center' border='0'>
	<tr>
		<td colspan='5' background='http://$admin_row[shopUrl]/admin/image/good_mail_join_tit2.gif' style='padding:75 0 0 35' height='162'><b><font color='#FF4800'>$admin_row[comName]</font></b>의 회원이 되신걸 진심으로 축하드립니다.</td>
	</tr>
</table>
<table width='700' border='0' cellspacing='0' cellpadding='0' align='center'>
	<tr>
		<td background='http://$admin_row[shopUrl]/admin/image/good_mail_bg2.gif'>";
		if (empty($name)) $name = "회원명";
		$body_DB = $admin_row[mail_join];
		$body_DB = str_replace("__NAME",$name,$body_DB);
		$body_DB = str_replace("__LOGO",$logo,$body_DB);
		$body_DB = str_replace("__COMNAME",$admin_row[comName],$body_DB);
		$body_DB = str_replace("__BOTTOM_HTML",$admin_row[mail_bottom],$body_DB);
		$body .=$body_DB;
		$body.="
		</td>
	</tr>
