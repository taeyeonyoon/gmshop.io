...
{
	window.open("goods_ask_comment_del.php?idx="+idx,"","scrollbars=no,width=300,height=140,top=50,left=50");
}
//-->
</SCRIPT>
</head>
		...
		<td background='image/sub/good_ask_bg.gif' colspan='3' align='center'>
			...
			<table width="560" border=0 align="center" cellpadding='0' cellspacing='0'>
				...
				<tr bgcolor='e3edf6'>
					...
					<td width='40'><?
					if ($_SESSION["GOOD_SHOP_USERID"] == $goods_board_row[userid])
					{
						?><a href="javascript:del(<?=$goods_board_row[idx]?>);"><img src="image/icon/btn_delete0.gif" border=0></a><?
					}
					?></td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan='2' bgcolor='ffffff' style='padding:10 10 10 10'><?=nl2br($goods_board_row[content])?></td>
				</tr>
				<tr>
					<td colspan='2' bgcolor='e1e1e1' height='1'></td>
				</tr>
			...
			<table width="560" border=0 align="center" cellpadding='0' cellspacing='0'>
				...
				<tr>
					<td align=right height='25'><a href="javascript:self.close();"><img src="image/icon/close.gif" border=0></a></td>
				</tr>
			</table>
		</td>
	</tr>
