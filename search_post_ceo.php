...
function choice(f)
{
	...
	opform.ceo_address1.value = f.add.value;
	opform.ceo_zip1.value = f.zip1.value;
	opform.ceo_zip2.value=f.zip2.value;
	opform.ceo_address2.focus();
	window.close();
}
function sendit()
{
...
<body bgcolor="#FFFFFF" text="#464646" leftmargin="10" topmargin="10" marginwidth="10" marginheight="10" onload="document.frmzipsearch.zipcode.focus();reSize();">
				...
				<tr>
					<td  width="450" valign="top">
						<table width="430" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td valign="top"><br>
									<form method="post" action="search_post_ceo.php" name="frmzipsearch">
									...
									<table width="98%" border="0" cellspacing="0" cellpadding="0" align="center">
										...
										<tr>
											...
											<td width="170" style='padding:0 0 0 5'><a href="javascript:sendit();"> <img src="image/icon/search.gif" border="0"></a> </td>
										</tr>
										</form><!-- post -->
										<tr>
